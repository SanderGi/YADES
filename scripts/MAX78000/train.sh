...
python train.py --lr 0.01 --optimizer SGD --epochs 10 --deterministic --seed 1 --compress policies/schedule.yaml --model yolo_pico --dataset animal_detection --confusion --param-hist --pr-curves --embedding --device MAX78000 --qat-policy policies/qat_policy_fast.yaml "$@"
